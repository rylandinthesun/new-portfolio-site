  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name='description' content='Full-Stack Software Engineer who was a Full-Time Touring Musician for 10+ years.' />
        ...
        <meta property='og:description' content='Full-Stack Software Engineer who was a Full-Time Touring Musician for 10+ years.' />
        {/* Twitter */}
        <meta name='twitter:card' content='summary' />
        <meta property='twitter:title' content='Ryland Oehlers Portfolio Website' />
        ...
        <meta property='twitter:description' content='Full-Stack Software Engineer who was a Full-Time Touring Musician for 10+ years.' />
      </Head>
      ...
      <main className={styles.main}>
        ...
        <Image src={selfPortrait} alt='Picture of the author' width={350} height={450} objectFit='cover' quality={75} loading='eager' />
      </main>
      ...
      <section ref={summaryRef} className={styles.summary}>
        ...
        <div className={`${styles.content} para-animate`}>
          <p>Full-Stack Software Engineer who was a Full-Time Touring Musician for 10+ years. Specializing in Front-End Development, I am passionate about bringing together creative designs with code.</p>
          <section className={styles.socials}>
            <SocialLink url='mailto:ryland.oehlers@gmail.com?subject=Website Inquiry' icon={<FiMail color='#EA4335' />} />
            <SocialLink url='https://www.linkedin.com/in/rylandoehlers' icon={<FaLinkedin color=' #0077B5' />} />
            <SocialLink url='https://www.github.com/rylandinthesun' icon={<FaGithub color='#F4CBB2' />} />
            <SocialLink url='https://www.instagram.com/rylandinthesun' icon={<FaInstagram color='#F58529' />} />
            <SocialLink url='https://www.twitter.com/rylandinthesun' icon={<FaTwitter color='#55ACEE' />} />
          </section>
        </div>
      </section>
      ...
      <section ref={toolKitRef} className={styles.toolKit}>
        <div className={styles.tools}>
          ...
          <ToolkitIcon icon={<SiTailwindcss color='#4dc0b5' />} name='Tailwind' />
